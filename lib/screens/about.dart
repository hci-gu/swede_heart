        ...
        child: ListView(
          ...
          children: [
            ...
            _subSection('Vad händer med dina uppgifter?', [
              'Ändamålet med behandlingen av dina personuppgifter är att genomföra det ovan beskrivna forskningsprojektet. Projektet kommer att samla in och registrera information om dig. Följande information samlas in:\n',
              ...
              'Den rättsliga grunden för behandlingen av dina personuppgifter är att behandlingen är nödvändig för att utföra en uppgift av allmänt intresse (artikel 6.1 e GDPR). Behandlingen av dina känsliga personuppgifter är nödvändig för vetenskapliga forskningsändamål och sker i enlighet med etikprövningslagen (artikel 9.2 j GDPR). Inga uppgifter kommer att överföras utanför EU/EES.\n',
              'Dina svar och resultat kommer att behandlas så att inte obehöriga kan ta del av dem. Vi kommer att spara dina personuppgifter 10 år efter att forskningsprojektet avslutats, i enlighet med gällande arkivbestämmelser.\n',
